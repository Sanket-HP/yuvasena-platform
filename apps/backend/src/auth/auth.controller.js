...
var shared_1 = require("@yuvasena/shared");
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    parseResult = shared_1.MemberRegisterSchema.safeParse(body);
                    if (!parseResult.success) {
                        throw new common_1.BadRequestException({
                            message: 'Validation failed',
                            errors: parseResult.error.errors.map(function (e) { return "".concat(e.path.join('.'), ": ").concat(e.message); })
                        });
                    }
                    return [2 /*return*/, this.authService.register(parseResult.data)];
                });
            });
        };
        AuthController_1.prototype.login = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                var parseResult;
                return __generator(this, function (_a) {
                    parseResult = shared_1.EmailLoginSchema.safeParse(body);
                    if (!parseResult.success) {
                        throw new common_1.BadRequestException({
                            message: 'Validation failed',
                            errors: parseResult.error.errors.map(function (e) { return "".concat(e.path.join('.'), ": ").concat(e.message); })
                    ...
                    return [2 /*return*/, this.authService.loginWithEmail(parseResult.data)];
                });
            });
        };
        AuthController_1.prototype.requestOtp = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                var parseResult;
                return __generator(this, function (_a) {
                    parseResult = shared_1.OtpRequestSchema.safeParse(body);
                    if (!parseResult.success) {
                        throw new common_1.BadRequestException({
                            message: 'Validation failed',
                            errors: parseResult.error.errors.map(function (e) { return "".concat(e.path.join('.'), ": ").concat(e.message); })
                    ...
                    return [2 /*return*/, this.authService.requestOtp(parseResult.data)];
                });
            });
        };
        AuthController_1.prototype.verifyOtp = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                var parseResult;
                return __generator(this, function (_a) {
                    parseResult = shared_1.OtpVerifySchema.safeParse(body);
                    if (!parseResult.success) {
                        throw new common_1.BadRequestException({
                            message: 'Validation failed',
                            errors: parseResult.error.errors.map(function (e) { return "".concat(e.path.join('.'), ": ").concat(e.message); })
                    ...
                    return [2 /*return*/, this.authService.verifyOtp(parseResult.data)];
                });
            });
        };
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Register a new member' }), (0, swagger_1.ApiResponse)({ status: 201, description: 'User successfully registered' }), (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid input schema' }), (0, swagger_1.ApiResponse)({ status: 409, description: 'Email or Mobile number already in use' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Login with email and password' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Login successful, returns JWT access token' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid credentials or suspended account' })];
        _requestOtp_decorators = [(0, common_1.Post)('otp/request'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Request OTP for mobile authentication' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'OTP sent' })];
        _verifyOtp_decorators = [(0, common_1.Post)('otp/verify'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Verify mobile OTP and authenticate' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Authentication successful or new user redirection code' })];
        _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Retrieve currently logged-in user profile' }), (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns authenticated user information' }), (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized request' })];
